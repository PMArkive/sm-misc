...
// Declare global ConVar handles
ConVar gCV_SV_Airaccelerate;
ConVar gCV_SV_MaxVelocity;

public Plugin myinfo =
{
    name = "TAS Velocity Predictor",
    author = "Your Name",
    description = "Predicts player velocity on surf ramps for TAS optimization and visualizes trajectories",
...
{
    // Create and check critical ConVars
...
void PredictVelocity(int client)
{
    ...
    if (IsPlayerOnSurfRamp(client, surfaceNormal))
    {
        ...
        if (airAccelerate != 0.0)
        {
            ...
            float maxWishSpeed = 30.0; // Change this value if sv_air_max_wishspeed is different in your game
